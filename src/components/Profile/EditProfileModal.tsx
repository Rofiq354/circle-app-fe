...
const EditProfileModal: React.FC<EditProfileModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="bg-[#1f1f1f] max-h-[90vh] flex flex-col w-full max-w-2xl rounded-2xl overflow-hidden border border-[#333] shadow-2xl">
        {/* Header */}
        ...
        >
          ...
          {/* Footer Save */}
          <div className="flex justify-end shrink-0 p-6 border-t border-[#333]">
            <button
              type="submit"
